...
import dashboard from "./figma/dashboard.webp";
import WeighMast from "./figma/WeighMAST_W2.webp";
import {
    IconBrightnessDown,
    IconBrightnessUp,
        ...
        <div
            ...
            <motion.h2
                ...
                {title || (
                    ...
                    >
                        {/* Glow Behind Text */}
                        <span className="absolute inset-0 blur-3xl opacity-30 bg-gradient-to-r from-[#0F4C81] via-[#0F5F8A] to-[#0F7173]"></span>

                        {/* Animated Gradient Text */}
                        <span className="relative bg-gradient-to-r from-[#0F4C81] via-[#0F5F8A] to-[#0F7173] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradientMove">
...
export const Lid = ({
    ...
    // 🔥 Fade BEFORE reaching next section
            ...
            >
                ...
                >
                    <img
                        src={WeighMast}
                        alt="WeighMAST Logo"
                        className="w-20 h-auto opacity-90 drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]"
                    />
                </div>
            </div>
